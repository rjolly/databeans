 ...
 * server.
 */
public class ClassFileJarServer extends ClassServer {
    
    private JarFile classpath;
     ...
     */
    public ClassFileJarServer(int port, JarFile classpath) throws IOException
    {
	super(port);
	...
	try {
	    new ClassFileJarServer(port, new JarFile(classpath));
	} catch (IOException e) {
